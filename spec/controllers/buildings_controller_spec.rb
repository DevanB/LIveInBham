  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved building as @building" do
        ...
        post :create, {:building => { "name" => "invalid value" }}, valid_session
        assigns(:building).should be_a_new(Building)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested building" do
        ...
        Building.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => building.to_param, :building => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the building as @building" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Building.any_instance.stub(:save).and_return(false)
        put :update, {:id => building.to_param, :building => { "name" => "invalid value" }}, valid_session
        assigns(:building).should eq(building)
      end
