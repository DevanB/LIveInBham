...
describe UnitsController do
  ...
  let(:valid_attributes) { { "featured" => "false" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved unit as @unit" do
        ...
        post :create, {:unit => { "featured" => "invalid value" }}, valid_session
        assigns(:unit).should be_a_new(Unit)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested unit" do
        ...
        Unit.any_instance.should_receive(:update).with({ "featured" => "false" })
        put :update, {:id => unit.to_param, :unit => { "featured" => "false" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the unit as @unit" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Unit.any_instance.stub(:save).and_return(false)
        put :update, {:id => unit.to_param, :unit => { "featured" => "invalid value" }}, valid_session
        assigns(:unit).should eq(unit)
      end
